...
// bytes w = 2;
inline void Address::clear_w() {
  _impl_.w_.ClearToEmpty();
}
inline const std::string& Address::w() const {
  // @@protoc_insertion_point(field_get:Address.w)
  return _internal_w();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Address::set_w(ArgT0&& arg0, ArgT... args) {
 
 _impl_.w_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Address.w)
}
inline std::string* Address::mutable_w() {
  std::string* _s = _internal_mutable_w();
  // @@protoc_insertion_point(field_mutable:Address.w)
  return _s;
}
inline const std::string& Address::_internal_w() const {
  return _impl_.w_.Get();
}
inline void Address::_internal_set_w(const std::string& value) {
  
  _impl_.w_.Set(value, GetArenaForAllocation());
}
inline std::string* Address::_internal_mutable_w() {
  
  return _impl_.w_.Mutable(GetArenaForAllocation());
}
inline std::string* Address::release_w() {
  // @@protoc_insertion_point(field_release:Address.w)
  return _impl_.w_.Release();
}
inline void Address::set_allocated_w(std::string* w) {
  if (w != nullptr) {
  ...
  // @@protoc_insertion_point(field_set_allocated:Address.w)
}
